...
FROM `smiling-rhythm-486213-b9.transformed_data.cleaned_and_filtered`
...
SELECT 
    ...
    z.Zone,
    COUNT(*) AS total_trips
FROM `smiling-rhythm-486213-b9.transformed_data.cleaned_and_filtered` t
JOIN `smiling-rhythm-486213-b9.raw_yellowtrips.taxi_zone` z
...
SELECT 
    ...
    COUNT(*) AS total_trips
FROM `smiling-rhythm-486213-b9.transformed_data.cleaned_and_filtered` t
JOIN `smiling-rhythm-486213-b9.raw_yellowtrips.taxi_zone` pz 
    ON t.PULocationID = pz.LocationID
JOIN `smiling-rhythm-486213-b9.raw_yellowtrips.taxi_zone` dz 
